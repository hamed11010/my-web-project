...
async function handleLogin(e) {
    ...
    try {
        ...
        Swal.fire({
            ...
            if (returnTo) {
                // Redirect to the return URL with the new token
                window.location.href = `${returnTo}?token=${data.token}`;
                ...
                if (pendingOrderId) {
                    ...
                    window.location.href = `/order-confirmation/${pendingOrderId}?token=${data.token}`;
